...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const weaponData = [
        ...
        { nome: 'Adaga', dano: '1d4', tipo: 'Perfurante', maestria: 'Incissão', propriedades: 'Ágil, Leve, Arremesso (6/18)' },
        { nome: 'Azagaia', dano: '1d6', tipo: 'Perfurante', maestria: 'Lentidão', propriedades: 'Arremesso (9/36)' },
        { nome: 'Cajado (Bordão)', dano: '1d6', tipo: 'Contundente', maestria: 'Derrubar', propriedades: 'Versátil (1d8)' },
        { nome: 'Clava Grande', dano: '1d8', tipo: 'Contundente', maestria: 'Empurrão', propriedades: 'Duas Mãos' },
        { nome: 'Foice Curta', dano: '1d4', tipo: 'Cortante', maestria: 'Incissão', propriedades: 'Leve' },
        { nome: 'Lança', dano: '1d6', tipo: 'Perfurante', maestria: 'Esgotar', propriedades: 'Versátil (1d8), Arremesso (6/18)' },
        { nome: 'Maça', dano: '1d6', tipo: 'Contundente', maestria: 'Esgotar', propriedades: '-' },
        { nome: 'Machadinha', dano: '1d6', tipo: 'Cortante', maestria: 'Irritar', propriedades: 'Leve, Arremesso (6/18)' },
        { nome: 'Martelo Leve', dano: '1d4', tipo: 'Contundente', maestria: 'Incissão', propriedades: 'Leve, Arremesso (6/18)' },
        { nome: 'Porrete', dano: '1d4', tipo: 'Contundente', maestria: 'Lentidão', propriedades: 'Leve' },
        { nome: 'Arco Curto', dano: '1d6', tipo: 'Perfurante', maestria: 'Irritar', propriedades: 'Munição, Duas Mãos, Alcance (24/96)' },
        { nome: 'Besta Leve', dano: '1d8', tipo: 'Perfurante', maestria: 'Lentidão', propriedades: 'Munição, Recarga, Duas Mãos, Alcance (24/96)' },
        { nome: 'Dardo', dano: '1d4', tipo: 'Perfurante', maestria: 'Irritar', propriedades: 'Ágil (Finesse), Arremesso (6/18)' },
        { nome: 'Funda', dano: '1d4', tipo: 'Contundente', maestria: 'Lentidão', propriedades: 'Munição, Alcance (9/36)' },
        { nome: 'Alabarda', dano: '1d10', tipo: 'Cortante', maestria: 'Trespassar', propriedades: 'Pesada, Alcance (Reach), Duas Mãos' },
        { nome: 'Chicote', dano: '1d4', tipo: 'Cortante', maestria: 'Lentidão', propriedades: 'Ágil (Finesse), Alcance (Reach)' },
        { nome: 'Cimitarra', dano: '1d6', tipo: 'Cortante', maestria: 'Incissão', propriedades: 'Ágil (Finesse), Leve' },
        { nome: 'Espada Curta', dano: '1d6', tipo: 'Perfurante', maestria: 'Irritar', propriedades: 'Ágil (Finesse), Leve' },
        { nome: 'Espada Duas Mãos (Montante)', dano: '2d6', tipo: 'Cortante', maestria: 'Trespassar', propriedades: 'Pesada, Duas Mãos' },
        { nome: 'Espada Longa', dano: '1d8', tipo: 'Cortante', maestria: 'Esgotar', propriedades: 'Versátil (1d10)' },
        { nome: 'Florete', dano: '1d8', tipo: 'Perfurante', maestria: 'Irritar', propriedades: 'Ágil (Finesse)' },
        { nome: 'Glaive', dano: '1d10', tipo: 'Cortante', maestria: 'Relance', propriedades: 'Pesada, Alcance (Reach), Duas Mãos' },
        { nome: 'Lança de Montaria', dano: '1d12', tipo: 'Perfurante', maestria: 'Derrubar', propriedades: 'Alcance (Reach), Duas Mãos (exceto se montado)' },
        { nome: 'Maça Estrela', dano: '1d8', tipo: 'Perfurante', maestria: 'Esgotar', propriedades: '-' },
        { nome: 'Machado de Batalha', dano: '1d8', tipo: 'Cortante', maestria: 'Derrubar', propriedades: 'Versátil (1d10)' },
        { nome: 'Machado Grande', dano: '1d12', tipo: 'Cortante', maestria: 'Trespassar', propriedades: 'Pesada, Duas Mãos' },
        { nome: 'Mangual', dano: '1d8', tipo: 'Contundente', maestria: 'Esgotar', propriedades: '-' },
        { nome: 'Marreta (Malho)', dano: '2d6', tipo: 'Contundente', maestria: 'Derrubar', propriedades: 'Pesada, Duas Mãos' },
        { nome: 'Martelo de Guerra', dano: '1d8', tipo: 'Contundente', maestria: 'Empurrão', propriedades: 'Versátil (1d10)' },
        { nome: 'Picareta de Guerra', dano: '1d8', tipo: 'Perfurante', maestria: 'Esgotar', propriedades: '-' },
        { nome: 'Pique', dano: '1d10', tipo: 'Perfurante', maestria: 'Empurrão', propriedades: 'Pesada, Alcance (Reach), Duas Mãos' },
        { nome: 'Tridente', dano: '1d6', tipo: 'Perfurante', maestria: 'Derrubar', propriedades: 'Arremesso (6/18), Versátil (1d8)' },
        { nome: 'Arco Longo', dano: '1d8', tipo: 'Perfurante', maestria: 'Irritar', propriedades: 'Munição, Pesada, Duas Mãos, Alcance (45/180)' },
        { nome: 'Besta de Mão', dano: '1d6', tipo: 'Perfurante', maestria: 'Irritar', propriedades: 'Munição, Leve, Recarga, Alcance (9/36)' },
        { nome: 'Besta Pesada', dano: '1d10', tipo: 'Perfurante', maestria: 'Lentidão', propriedades: 'Munição, Pesada, Recarga, Duas Mãos, Alcance (30/120)' },
        { nome: 'Rede', dano: '--', tipo: '-', maestria: 'Derrubar', propriedades: 'Arremesso (1,5/4,5), Especial' },
        { nome: 'Zarabatana', dano: '1', tipo: 'Perfurante', maestria: 'Lentidão', propriedades: 'Munição, Recarga, Alcance (7,5/30)' },
        { nome: 'Mosquete', dano: '1d12', tipo: 'Perfurante', maestria: 'Lentidão', propriedades: 'Carregamento, Duas Mãos, Alcance (12/36)' },
        { nome: 'Pistola', dano: '1d10', tipo: 'Perfurante', maestria: 'Irritar', propriedades: 'Carregamento, Alcance (9/27)' },
    ];
